%% Stabilność kaskadowego układu regulacji %% statyzm 5%

close all
%% statyzm 5%
clear statyzm
statyzm=0.05*omega_n;
otwarty_model;
...
% pełen Nyquist
nyquist(Go)
title("Wykres Nyquista - statyzm \Delta\omega=0.5\omega_N")
hold on
...
text(1.1, -250, sprintf("Dopuszczalne opóźnienie \\tau_{max}=%.4fs", Pm*pi/180/Wcp))
